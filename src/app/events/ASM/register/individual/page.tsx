            ...
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Field>
                  ...
                  <FieldContent>
                    <Input {...register("department")} placeholder="Dept shortform (e.g.CS, DOC)" className={formState.errors.department ? "border-red-400" : ""} />
                ...
                <Field>
                  ...
                  <FieldContent>
                    <Input {...register("classSection")} placeholder="e.g. 1 BCA A, 1 BCOM F, 2 MDS B" className={formState.errors.classSection ? "border-red-400" : ""} />
