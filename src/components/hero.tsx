...
export function HeroSection() {
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-[url('https://raw.githubusercontent.com/Joel-bca/dpe_assests_RR/6e0374695fd4d95093047e556f94710d41e7b2ef/hero-bg.jpg')] bg-cover bg-center brightness-[0.55]"></div>
